...
class Stats(commands.Cog):
    ...
    @commands.command()
    @commands.cooldown(1, 3, BucketType.user)
    async def privacy(self, ctx, *, subcommand: str | None = None):
        # Display generic privacy info
        if subcommand is None or subcommand == "info":
            await ctx.send(
                "FlandersBOT stores the user ID (e.g. 221609683562135553) privately and stores the username "
        ...
        # Adjust privacy settings for user
            ...
            msg = await ctx.send(
                "By default, all trivia participants are visible to the public in the trivia "
        ...
        # Remove all data logged for user
            ...
            msg = await ctx.send(
                "Would you like to erase all your user data?\nThis will remove you from the trivia "
            ...
            if react.emoji == "✅":
                ...
                await msg.edit(
                    content="All data relating to your account has been deleted.\nIf you wish to "
